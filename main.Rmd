...
```{r resi-plot, dev='png', fig.show='hide', message=FALSE, warning=FALSE}
# p = 1, d = 1, q = 1, P = 0,  D = 1, Q = 1, s = 12
sarima(vicTemp, 1,1,1, 0,1,1, 12) # Fig4
```
<center><b>Figure 4. Residuals plots</b></center>
![](`r knitr::fig_chunk('resi-plot', 'png')`)
